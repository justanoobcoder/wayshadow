#ifndef WAYSHADOW_WINDOW_HPP
#define WAYSHADOW_WINDOW_HPP
...
class WindowManager {
 public:
  ...
  void CreateWindow(ClientState& state);
  void ShowWindow(ClientState& state);
  void HideWindow(ClientState& state);
