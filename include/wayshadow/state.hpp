#ifndef WAYSHADOW_STATE_HPP
#define WAYSHADOW_STATE_HPP
...
struct MouseState {
  ...
  struct timespec last_click_time{.tv_sec = 0, .tv_nsec = 0};
  struct timespec hold_start_time{.tv_sec = 0, .tv_nsec = 0};
...
struct ClientState {
  ...
  struct timespec last_key_time{.tv_sec = 0, .tv_nsec = 0};
  ...
  Color current_combo_color{colors::kWhite};
